...
_REGISTRY: dict[Workflow, GraphBuilder] = {
    ...
    Workflow.STRATEGY_FORM_IDEA_GENERATION: strategy_form_idea_generation.build,
    Workflow.STRATEGIC_FORESIGHT_REPORT: strategic_foresight_report.build,
}
